 ...
 *
 * Copyright © 2008 Microchip Technology Inc.  All rights reserved.  Microchip
 * licenses to you the right to use, modify, copy and distribute Software only
 * when embedded on a Microchip microcontroller or digital signal controller,
 * which is integrated into your product or third party product (pursuant to
 * the sublicense terms in the accompanying license agreement).  
 *
